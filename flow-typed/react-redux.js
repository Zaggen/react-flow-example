...
import type { $StateTree } from 'reducers'
/*
...
declare module "react-redux" {
  // -----------------------------------------------------------------
  // Copied from Recompose to enable type inference of different HOCs
  // -----------------------------------------------------------------
  declare type UnaryFn<A, R> = (a: A) => R
  
  declare type Component<A> = React$ComponentType<A>
  
  declare type HOC<Base, Enhanced> = UnaryFn<Component<Base>,
    Component<Enhanced>>
  // -----------------------------------------------------------------
  // END OF Copied from Recompose to enable type inference of different HOCs
  // -----------------------------------------------------------------
  
  // overloaded typings of "connect" for different arguments using recompose types
  declare function connect<MapperAdd, DispatchAdd, Enhanced>(
    mapper: (state: $StateTree) => MapperAdd,
    dispatch: DispatchAdd
  ): HOC<{ ...$Exact<Enhanced>, ...MapperAdd, ...DispatchAdd }, Enhanced>
  
  declare function connect<DispatchAdd, Enhanced>(
    mapper: null,
    dispatch: DispatchAdd
  ): HOC<{ ...$Exact<Enhanced>, ...DispatchAdd }, Enhanced>
  
  declare export function connect<MapperAdd, Enhanced>(
    mapper: (state: $StateTree) => MapperAdd
  ): HOC<{ ...$Exact<Enhanced>, ...MapperAdd }, Enhanced>
}